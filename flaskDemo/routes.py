...
from flaskDemo.models import Category,Customers, OrderDetails, Orders, Payment, Products, Shippers, Suppliers, Supply
...
def new_assign():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('You have assigned an employee!', 'success')
        return redirect(url_for('home'))
    return render_template('create_dept.html', title='Assign an Employee',
